...
const GUIDE_ITEMS: GuideItem[] = [
  ...
  { title: '記録を見る', description: '一覧の項目をクリックすると、その作業の時間帯を確認できます。' },
  { title: '記録を編集', description: '一覧の項目にカーソルを合わせると出る鉛筆ボタン、または右クリックのメニューから編集できます。' },
  { title: '追加・削除', description: '一覧を右クリックしてメニューから追加・削除します。追加では開始・終了の時刻を入力します。' },
  { title: '並び替え', description: '項目をドラッグすると順序を入れ替えられます。' },
  { title: '休憩・終了', description: 'カード下部のボタンで休憩や業務終了を記録します。' },
  { title: 'カレンダー', description: '下部の「カレンダー」を押すと大きな画面が開き、週や月で記録を振り返れます。' },
